...
<body>
	...
	<h4 class ="modal-title"id="modalLabel">Excluir pais
	</h4>
	</div>
	...
	<div class="col-md-3"> <a href="index.jsp" class="btn btn-primary pull-right h2">Novo Pais</a>
	</div>
	</div>
	<!-- /#top -->
	</form>
	...
	<c:if test="${not empty lista}">
		<div id ="list"class="row"> <div class ="table-responsivecol-md-12">
		...
		<!-- /#list --> <div id ="bottom"class="row"> <div class="col-md-12">
		<!-- paginação ainda não foi implementada --> <ul class="pagination">
		<li class="disabled">
		<a>&lt; Anterior</a>
		</li>
		<li class="disabled">
